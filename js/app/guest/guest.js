...
export const guest = (() => {
    ...
    const showGuestName = () => {
        ...
        if (name) {
            ...
            const template = `<small class="mt-0 mb-1 mx-0 p-0 text-white">${util.escapeHtml(guestName?.getAttribute('data-message'))}</small><p class="m-0 p-0 text-white font-black" style="font-size: 1.5rem;">${util.escapeHtml(name)}</p>`;
    ...
    const buildGoogleCalendar = () => {
        ...
        const data = {
            action: 'TEMPLATE',
            text: 'Pernikahan Mukti dan Ukhti',
            dates: `${formatDate('2025-06-22 10:00')}/${formatDate('2025-06-22 15:00')}`,
            details: 'Tanpa mengurangi rasa hormat, kami mengundang Anda untuk berkenan menghadiri acara pernikahan kami. Terima kasih atas perhatian dan doa restu Anda, yang menjadi kebahagiaan serta kehormatan besar bagi kami.',
            location: 'https://g.co/kgs/YSH9vHb',
            ctz: 'Asia/Jakarta',
        };
